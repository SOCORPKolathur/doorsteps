...
class ProductPage2 extends StatefulWidget {
  ...
  String shopid;
  String vendername;
  ProductPage2(this.ProductID,this.shopid,this.vendername);
...
class _ProductPage2State extends State<ProductPage2> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: FutureBuilder(
          future: FirebaseFirestore.instance.collection("Shops").doc(widget.shopid).collection("Products").doc(widget.ProductID).get(),
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          checkvender(item["name"],item["quantity"],item["price"],item["image"],widget.vendername);
                        },
                        child: Container(
