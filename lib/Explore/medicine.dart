...
class _MedicineState extends State<Medicine> {
  ...
  checkfun() async {
    ...
    for(int i=0;i<doc1.docs.length;i++){
      if(doc1.docs[i]["type1"]=="Medicine"||doc1.docs[i]["type2"]=="Medicine"||doc1.docs[i]["type3"]=="Medicine"){
        setState(() {
          doccheck=doccheck+1;
        });
      }
      ...
      body: doccheck==0? Column(
        children: [
          Padding(
            ...
            child: Text("Medicine",style: GoogleFonts.poppins(
              color: Colors.black,
                        ...
                        builder: (context, snapshot) {
                          ...
                          return ListView.builder(
                              ...
                              itemBuilder: (context,index) {
                                ...
                                return
                                  val["type1"]=="Medicine"||val["type2"]=="Medicine"||val["type3"]=="Medicine"?
