...
class _MeatState extends State<Meat> {
  ...
  checkfun() async {
    ...
    for(int i=0;i<doc1.docs.length;i++){
      if(doc1.docs[i]["type1"]=="Meat"||doc1.docs[i]["type2"]=="Meat"||doc1.docs[i]["type3"]=="Meat"){
        setState(() {
          doccheck=doccheck+1;
        });
      }
      ...
      body: doccheck==0? Column(
        children: [
          Padding(
            ...
            child: Text("Meat",style: GoogleFonts.poppins(
              color: Colors.black,
                        ...
                        builder: (context, snapshot) {
                          ...
                          return ListView.builder(
                              ...
                              itemBuilder: (context,index) {
                                ...
                                return
                                  val["type1"]=="Meat"||val["type2"]=="Meat"||val["type3"]=="Meat"?
