...
class _HotelState extends State<Hotel> {
  ...
  checkfun() async {
    ...
    for(int i=0;i<doc1.docs.length;i++){
      if(doc1.docs[i]["type1"]=="Hotels"||doc1.docs[i]["type2"]=="Hotels"||doc1.docs[i]["type3"]=="Hotels"){
        setState(() {
          doccheck=doccheck+1;
        });
      }
      ...
      body: doccheck==0? Column(
        children: [
          Padding(
            ...
            child: Text("Hotels & Fast Food",style: GoogleFonts.poppins(
              color: Colors.black,
                  ...
                  children:[
                        ...
                        builder: (context, snapshot) {
                          ...
                          return ListView.builder(
                              ...
                              itemBuilder: (context,index) {
                                ...
                                return
                                  val["type1"]=="Hotels"||val["type2"]=="Hotels"||val["type3"]=="Hotels"?
                    ...
                    Row(
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(top: 10.0,left: 10),
                          child: Text("Shop by Favorites Foods",style: GoogleFonts.poppins(
                            color: Colors.black,
                            fontWeight: FontWeight.w700,
                            fontSize: width/15.84,
                          )),
