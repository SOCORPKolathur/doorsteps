...
class Backery extends StatefulWidget {
  const Backery({Key? key}) : super(key: key);

  @override
  State<Backery> createState() => _BackeryState();
}

class _BackeryState extends State<Backery> {
  int doccheck=0;
  checkfun() async {
    setState(() {
      doccheck=0;
    ...
    for(int i=0;i<doc1.docs.length;i++){
      if(doc1.docs[i]["type1"]=="Bakery"||doc1.docs[i]["type2"]=="Bakery"||doc1.docs[i]["type3"]=="Bakery"){
        setState(() {
          doccheck=doccheck+1;
        });
      }
      ...
      body: doccheck==0? Column(
        children: [
          Padding(
            ...
            child: Text("Bakery & Snacks",style: GoogleFonts.poppins(
              color: Colors.black,
                        ...
                        builder: (context, snapshot) {
                          ...
                          return ListView.builder(
                              ...
                              itemBuilder: (context,index) {
                                ...
                                return
                                  val["type1"]=="Bakery"||val["type2"]=="Bakery"||val["type3"]=="Bakery"?
